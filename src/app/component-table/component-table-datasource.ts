...
const EXAMPLE_DATA: ComponentTableItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class ComponentTableDataSource extends DataSource<ComponentTableItem> {
   ...
   */
  private getPagedData(data: ComponentTableItem[]): ComponentTableItem[] {
    if (this.paginator) {
